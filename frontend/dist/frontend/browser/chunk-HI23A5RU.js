...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;ed1f2b179fdf030ed47c8b1236372ab0bdf7e7aa8f1f1f8db54ed16bd97b090c;D:/Mustafa/CMS-17.4-CLEAN/frontend/src/app/shared/components/consent-preview-dialog/consent-preview-dialog.component.ts */\n.dlg {\n  max-height: 90vh;\n  display: flex;\n  flex-direction: column;\n}\n.dlg-head {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding-right: 8px;\n}\n.dlg-title {\n  margin: 0;\n  font-size: 18px;\n  font-weight: 700;\n}\n.dlg-x {\n  border: none;\n  background: transparent;\n  font-size: 22px;\n  cursor: pointer;\n  color: #64748b;\n}\n.dlg-info {\n  background: #eff6ff;\n  border: 1px solid #bfdbfe;\n  border-radius: 8px;\n  padding: 12px 14px;\n  font-size: 13px;\n  color: #1e40af;\n  margin-bottom: 16px;\n}\n.dlg-preview {\n  background: #fff;\n  padding: 32px;\n  border: 1px solid #e2e8f0;\n  border-radius: 8px;\n  font-size: 15px;\n  line-height: 1.8;\n  overflow: auto;\n  max-height: 60vh;\n}\n:host ::ng-deep .preview-tag {\n  background: #e0e7ff;\n  color: #4338ca;\n  padding: 2px 8px;\n  border-radius: 4px;\n  font-weight: 600;\n  font-size: 13px;\n}\n/*# sourceMappingURL=consent-preview-dialog.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-HI23A5RU.js.map
