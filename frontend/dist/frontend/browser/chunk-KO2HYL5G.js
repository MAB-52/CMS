...
var AuthService = class _AuthService {
  ...
  logout(options) {
    ...
    const nav = options?.sessionExpired === true ? this.router.navigate(["/login"], { queryParams: { reason: "session_expired" } }) : this.router.navigateByUrl("/login");
    void nav.then(() => {
      this.#isLoggingOut = false;
    }, () => {
      this.#isLoggingOut = false;
...
//# sourceMappingURL=chunk-KO2HYL5G.js.map
