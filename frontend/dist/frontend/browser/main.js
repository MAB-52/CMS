...
function LoginComponent_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\u274C ", ctx_r0.errorBanner(), "");
  }
}
...
var LoginComponent = class _LoginComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 38, vars: 12, consts: [[1, "login-page"], [1, "login-card"], [1, "brand-block"], [1, "logo-title"], [1, "logo-sub"], [1, "welcome"], [1, "sub"], [1, "err-banner"], [1, "form", 3, "ngSubmit", "formGroup"], [1, "field-wrap"], ["aria-hidden", "true", 1, "field-ico"], ["appearance", "outline", 1, "field"], ["matInput", "", "type", "email", "formControlName", "email", "autocomplete", "username"], ["matInput", "", "formControlName", "password", "autocomplete", "current-password", 3, "type"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], ["mat-flat-button", "", "color", "primary", "type", "submit", 1, "submit-btn", 3, "disabled"], [1, "version"], [1, "spin"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3);
        \u0275\u0275text(4, "ConsentIQ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "div", 4);
        \u0275\u0275text(6, "V2 \xB7 Maker-Checker Edition");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(11, LoginComponent_Conditional_11_Template, 2, 1, "div", 7);
        ...
        \u0275\u0275template(20, LoginComponent_Conditional_20_Template, 2, 0, "mat-error")(21, LoginComponent_Conditional_21_Template, 2, 0, "mat-error");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(31);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(32, LoginComponent_Conditional_32_Template, 2, 0, "mat-error");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(33, "button", 15);
        \u0275\u0275template(34, LoginComponent_Conditional_34_Template, 3, 0)(35, LoginComponent_Conditional_35_Template, 1, 0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(36, "p", 16);
        \u0275\u0275text(37, "ConsentIQ v2.0 \xB7 Secure \xB7 Compliant");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(11);
        \u0275\u0275conditional(ctx.errorBanner() ? 11 : -1);
        \u0275\u0275advance();
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(8);
        \u0275\u0275conditional(ctx.form.controls.email.touched && ctx.form.controls.email.hasError("required") ? 20 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.controls.email.touched && ctx.form.controls.email.hasError("email") ? 21 : -1);
        \u0275\u0275advance(7);
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.controls.password.touched && ctx.form.controls.password.hasError("required") ? 32 : -1);
        \u0275\u0275advance();
...
\r
    <form [formGroup]="form" (ngSubmit)="submit()" class="form">\r
      <div class="field-wrap">\r
        <span class="field-ico" aria-hidden="true">\u{1F4E7}</span>\r
        <mat-form-field appearance="outline" class="field">\r
          <mat-label>Email</mat-label>\r
          <input matInput type="email" formControlName="email" autocomplete="username" />\r
      ...
      <div class="field-wrap">\r
        <span class="field-ico" aria-hidden="true">\u{1F512}</span>\r
        <mat-form-field appearance="outline" class="field">\r
          <mat-label>Password</mat-label>\r
          <input\r
            matInput\r
            [type]="hidePw() ? 'password' : 'text'"\r
    ...
    <p class="version">ConsentIQ v2.0 \xB7 Secure \xB7 Compliant</p>\r
  </div>\r
</div>\r
`, styles: ["/* src/app/features/auth/login/login.component.scss */\n.login-page {\n  min-height: 100vh;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 24px;\n  background:\n    linear-gradient(\n      135deg,\n      #0f172a 0%,\n      #1e1b4b 50%,\n      #0f172a 100%);\n}\n.login-card {\n  width: 100%;\n  max-width: 420px;\n  background: #fff;\n  border-radius: 16px;\n  padding: 40px;\n  box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.35), 0 0 0 1px rgba(255, 255, 255, 0.06);\n}\n.brand-block {\n  text-align: center;\n  margin-bottom: 32px;\n}\n.logo-title {\n  font-size: 28px;\n  font-weight: 800;\n  color: #0f172a;\n}\n.logo-sub {\n  margin-top: 4px;\n  font-size: 12px;\n  color: #64748b;\n}\n.welcome {\n  margin: 0;\n  font-size: 22px;\n  font-weight: 700;\n  color: #0f172a;\n}\n.sub {\n  margin: 6px 0 20px;\n  font-size: 14px;\n  color: #64748b;\n}\n.err-banner {\n  background: #fef2f2;\n  border: 1px solid #fecaca;\n  border-radius: 8px;\n  padding: 10px 12px;\n  font-size: 14px;\n  color: #b91c1c;\n  margin-bottom: 16px;\n}\n.form {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.field-wrap {\n  display: flex;\n  align-items: flex-start;\n  gap: 8px;\n}\n.field-ico {\n  margin-top: 18px;\n  font-size: 18px;\n}\n.field {\n  flex: 1;\n  width: 100%;\n}\n.submit-btn {\n  width: 100%;\n  height: 44px !important;\n  margin-top: 12px;\n  font-weight: 600 !important;\n  border-radius: 10px !important;\n}\n.success-pulse {\n  animation: pulse-success 0.45s ease-out;\n}\n@keyframes pulse-success {\n  from {\n    box-shadow: 0 0 0 0 rgba(34, 197, 94, 0.6);\n  }\n  to {\n    box-shadow: 0 0 0 12px rgba(34, 197, 94, 0);\n  }\n}\n.spin {\n  display: inline-block;\n  animation: spin 0.8s linear infinite;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.version {\n  margin-top: 24px;\n  text-align: center;\n  font-size: 12px;\n  color: #94a3b8;\n}\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
...
var routes = [
  ...
  { path: "login", component: LoginComponent },
  {
    ...
    loadComponent: () => import("./chunk-WHJBJ6DL.js").then((m) => m.MakerLayoutComponent),
    children: [
      { path: "", pathMatch: "full", redirectTo: "dashboard" },
      {
        path: "dashboard",
        data: { title: "Dashboard", makerCrumb: "Dashboard" },
        loadComponent: () => import("./chunk-FYY3V45K.js").then((m) => m.MakerDashboardComponent)
      },
      {
        path: "consents",
        data: { title: "My Consents", makerCrumb: "My Consents" },
        loadComponent: () => import("./chunk-AHFQAIPH.js").then((m) => m.MyConsentsComponent)
      },
      {
        path: "consents/new",
        data: { title: "Create New Consent", makerCrumb: "Create Consent" },
        loadComponent: () => import("./chunk-3KVYILZM.js").then((m) => m.CreateConsentComponent)
      },
      {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-KRWFSRCT.js").then((m) => m.AuditTrailComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-TY3QEQ6S.js").then((m) => m.CheckerLayoutComponent),
    children: [
      { path: "", pathMatch: "full", redirectTo: "dashboard" },
      {
        path: "dashboard",
        data: { title: "Dashboard", checkerCrumb: "Dashboard" },
        loadComponent: () => import("./chunk-WHWBFRA3.js").then((m) => m.CheckerDashboardComponent)
      },
      {
        path: "pending",
        data: { title: "Pending Approvals", checkerCrumb: "Pending Approvals" },
        loadComponent: () => import("./chunk-XUWXSNMJ.js").then((m) => m.PendingApprovalsComponent)
      },
      {
        path: "consents/:id/review",
        data: { title: "Review Consent", checkerCrumb: "Review" },
        loadComponent: () => import("./chunk-GL2KEWRE.js").then((m) => m.ConsentReviewComponent)
      },
      {
        path: "history",
        data: { title: "Review History", checkerCrumb: "Review History" },
        loadComponent: () => import("./chunk-BSG6UW6H.js").then((m) => m.ReviewHistoryComponent)
      }
    ]
  },
  {
    ...
    loadChildren: () => import("./chunk-5ATRXOHH.js").then((m) => m.adminRoutes)
  },
  {
    path: "public/consent/respond",
    loadComponent: () => import("./chunk-FXMEOKM6.js").then((m) => m.PublicConsentRespondComponent)
  },
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastContainerComponent, selectors: [["app-toast-container"]], decls: 4, vars: 3, consts: [[1, "toast-stack"], [3, "toast"], [3, "dismiss", "toast"]], template: function ToastContainerComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        let tmp_0_0;
        \u0275\u0275advance();
        \u0275\u0275repeater((tmp_0_0 = \u0275\u0275pipeBind1(3, 0, ctx.notifications.toasts)) !== null && tmp_0_0 !== void 0 ? tmp_0_0 : \u0275\u0275pureFunction0(2, _c02));
      }
