...
import { channelsLabel } from '../../../core/utils/channel.util';
...
import { CheckerChannelPreviewComponent } from '../checker-channel-preview/checker-channel-preview.component';
...
export class ConsentReviewComponent implements OnInit {
  ...
  /** Exposed to the template so it can call channelsLabel(c) directly. */
  readonly channelsLabel = channelsLabel;
